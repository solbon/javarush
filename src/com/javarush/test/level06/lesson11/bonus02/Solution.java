...
public class Solution
{
    ...
    public static class Cat
    {
        ...
        {
            this.name = name;
//            System.out.println("Конструктор 1 параметр");
        ...
        Cat(String name, Cat father)
        {
            ...
            this.father = father;
            this.mother = null;
//            System.out.println("Конструктор 2 параметра");
...
//            System.out.println("Матери нет");
        ...
        Cat(String name, Cat father, Cat mother)
        {
            ...
            this.father = father;
            this.mother = mother;
//            System.out.println("Конструктор 3 параметра");
//            if (father != null) System.out.println("Отец " + father.name);
//            else System.out.println("Отца нет");
//            if (mother != null) System.out.println("Мать " + mother.name);
//            else System.out.println("Матери нет");
